...
use Bionic\ProjectBundle\Entity\Status;
use Bionic\ProjectBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BionicProjectBundle:Status')->findAll();
     ...
     * @Method("POST")
     * @Template("BionicProjectBundle:Status:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BionicProjectBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BionicProjectBundle:Status:edit.html.twig")
     */
